...
func (tm *K8sCluster) AddLocalOnlyIntercept(c context.Context, spec *manager.InterceptSpec) (*rpc.InterceptResult, error) {
	tm.accLock.Lock()
...
func (tm *K8sCluster) RemoveLocalOnlyIntercept(c context.Context, name, namespace string) error {
